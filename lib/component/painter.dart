...
class ArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final calculatedStartAngle = math.pi / 12 * startAngle;
    final calculatedSweepAngle = math.pi / 12 * sweepAngle;
    ...
    canvas.drawArc(rect, calculatedStartAngle, calculatedSweepAngle, useCenter, paint);
  }
